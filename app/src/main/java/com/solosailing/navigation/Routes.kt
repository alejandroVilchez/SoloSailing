...
object Routes {
    const val HOME = "home"
    const val LOGIN = "presentation/login/LoginScreen.kt"
    const val REGISTER = "presentation/login/RegisterScreen.kt"
    const val MAP = "presentation/map/MapScreen.kt"
    const val REGATTA_SIMULATION = "presentation/regatta/RegattaSimulationScreen.kt"
    const val PAST_REGATTAS = "presentation/regatta/PastRegattasScreen.kt"
